...
const Contact = () => {
    ...
    try {
      ...
      const response = await fetch('https://portfolio-235a.restdb.io/rest/mails', {
        ...
        headers: {
          ...
          'x-apikey': 'fd0324d466e23db97505499e04152af4e6cfc',
      ...
      const isCorsError = errorMessage.includes('fetch') || errorMessage.includes('CORS')

      if (isCorsError) {
        // Show success message anyway since data is being saved
        setSnackbar({
          show: true,
          message: 'Message sent! (Note: Please configure CORS in RestDB.io for proper confirmation)',
          type: 'success',
        })
  ...
  return (
    <section id="contact" className="section-container bg-gradient-to-br from-primary-600 to-primary-800 text-white">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-center">Let's Work Together</h2>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 mb-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="name" className="block text-sm font-medium mb-2 text-primary-100">
                  Your Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium mb-2 text-primary-100">
                  Your Email
                </label>
                <input
                  type="email"
            ...
            <div>
              <label htmlFor="contact" className="block text-sm font-medium mb-2 text-primary-100">
                Service Needed
              </label>
              <select
                id="contact"
              ...
              >
                ...
                <option value="Administrative Support" className="text-gray-900">Administrative Support</option>
                <option value="Research & Data Analysis" className="text-gray-900">Research & Data Analysis</option>
                <option value="Financial Documentation" className="text-gray-900">Financial Documentation</option>
                <option value="Content Curation" className="text-gray-900">Content Curation & Analysis</option>
                <option value="Team Collaboration" className="text-gray-900">Team Collaboration Support</option>
                <option value="Process Improvement" className="text-gray-900">Process Improvement</option>
                <option value="Other" className="text-gray-900">Other</option>
              </select>
            </div>

            <div>
              <label htmlFor="message" className="block text-sm font-medium mb-2 text-primary-100">
                Project Description
              </label>
              <textarea
                id="message"
